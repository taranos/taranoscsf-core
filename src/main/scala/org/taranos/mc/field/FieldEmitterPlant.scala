    ...
    extends FieldElementPlant
{
        ...
        patchDefOpt: Option[JsObject] = None): Unit =
    {
        ...
        emitterPatch.GetChannelsMap.foreach(pair =>
        {
            ...
            val oscillatorConstructor = FieldOscillator.Constructor(
        ...
        emitter: FieldEmitter) =
    {
        ...
        emitterPatch.GetOscillatorPatchKeysMap.foreach(pair =>
        {
            ...
            val oscillatorDestructor = FieldOscillator.Destructor(
        ...
        scope: Symbol): Unit =
    {
        ...
        _fieldEmitters.filter(_._1._1 == fieldKey).foreach(emitterPair =>
        {
            ...
            val fieldEmitterDestructor = FieldEmitter.Destructor(pairEmitterKey, scope)
        ...
        key match
        {
            case _: FieldEmitter.Key =>
                ...
                if (isRequired && opt.isEmpty)
                    throw FieldException(Cell.ErrorCodes.FieldEmitterUnknown)
                opt

            case _ => throw FieldException(Cell.ErrorCodes.FieldEmitterKeyInvalid)
        }
    }
    ...
    def GetElementCount(fieldKey: Field.Key): Int =
        _fieldEmitters.count(_._1._1 == fieldKey)
}
